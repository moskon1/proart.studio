  ...
  return (
    <footer className="py-10 bg-studio-darker ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-2 border-t border-white/5 ">
          <div className="text-white/60 text-[10px] uppercase tracking-[0.3em] font-bold">
          ...
          <a
            ...
            className="mt-3 md:mt-0 inline-flex min-h-11 items-center px-2 text-xs text-white/60 hover:text-studio-accent transition-colors"
